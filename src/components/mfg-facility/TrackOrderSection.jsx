      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-8">
        {img.map((item, index) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 w-full h-full bg-black opacity-0 hover:opacity-50 hover:cursor-pointer transition-opacity" onClick={() => window.open(item.link, "_blank")}>
            </div>
          </div>
        ))}
      </div>
